        ...
        <li class="gallery_item">
            <div class="menu-container">
                ...
                <div class="contextual-menu">
                    ...
                    <a href="index.php?command=editRec&galleryID=<?php echo htmlspecialchars($item->galleryID); ?>">Edit</a>
                    <a href="index.php?command=deleteRec&galleryID=<?php echo htmlspecialchars($item->galleryID); ?>" 
            ...
            <div class="gallery_title"><?php echo htmlspecialchars($item->name); ?></div>
            <p><?php echo htmlspecialchars($item->description); ?></p>

            <!-- Optional Links for Google Maps and Facebook -->
            <?php if (!empty($item->google_maps_link)) { ?>
            <a href="<?php echo htmlspecialchars($item->google_maps_link); ?>" target="_blank">View on Google Maps</a>
            <?php } ?>
            
            <?php if (!empty($item->facebook_link)) { ?>
            <a href="<?php echo htmlspecialchars($item->facebook_link); ?>" target="_blank">Visit on Facebook</a>
            <?php } ?>
        </li>
        <?php }
        } else { ?>
